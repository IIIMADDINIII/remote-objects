/**
 * JSON save Description of a list of objects, functions and
 * symbols.
 */
type GcObjectsDescription = GcObjectDescription[];

/**
 * JSON save Id of an object which might need to be garbage
 * collected.
 */
...
/**
 * JSON save Id of an object wich only available on the
 * remote site.
 */
...
/**
 * JSON save An GcId with the location of the object
 * specified.
 */
...
/**
 * JSON save Value Segment representing the reading of an
 * property.
 */
...
/**
 * JSON save Value Segment representing the call of an
 * function.
 */
...
/**
 * JSON save Value Segment representing the Creation of an
 * object.
 */
type ValueNewSegment = {
  ...
  type: "new";
  /**
   * Description of all the arguments to the constructor
   * call.
   */
  args: ValueDescription[];
};
...
/**
 * JSON save Value Segment representing the setting of an
 * property.
 */
...
export type ObjectDescription = {
  ...
  id: GcId;
  /**
   * List of Own Keys Descriptions of the object (To Support
   * stuff like ownKey).
   */
  ownKeys: OwnKeyDescription[];
  /**
   * List of all Keys Descriptions in the prototype chain
   * (To support stuff like hasKey; Empty list if Prototype
   * is not NullDescription).
   */
...
export type FunctionDescription = {
  ...
  prototype: LocalizedGcId | NullDescription;
  /**
   * Description of the Prototype property of the function
...
/**
 * JSON save description of a symbol. Symbols are
 * represented by a new symbol on the remote site.
 */
...
export type ValueRequestDescription = RemoteDescription & {
  ...
  type: "request";
  /**
   * List of garbage collected objects important for this
   * request.
   */
...
export type SyncGcRequest = {
  ...
  type: "syncGcRequest";
  /**
   * List of RemoteObjects or Symbol ID's which where
   * deleted since the last sync and can now be released
   * locally.
   */
  deletedItems: number[];
