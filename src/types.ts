 ...
 * @public
 */
export type RemoteFunction<T extends (...args: any[]) => any> = T extends (...args: infer Parameters) => infer ReturnType ? RemoteObj<T> & ((...args: RemoteFunctionParameters<Parameters>) => RemoteReturnType<ReturnType>) : never;
 ...
 * @public
 */
export type RemoteConstructor<T extends new () => any> = T extends new (...args: infer Parameters) => infer ReturnType ? RemoteObj<T> & (new (...args: RemoteFunctionParameters<Parameters>) => RemoteReturnType<ReturnType>) : never;
 ...
 * @public
 */
export type Local<T> = T extends Primitives ? T : T extends (...args: any[]) => any ? LocalFunction<T> : T extends new (...args: any[]) => any ? LocalConstructor<T> : T extends Remote<infer R> ? R : Remote<T>;
 ...
 * @public
 */
export type LocalFunction<T extends (...args: any[]) => any> = T extends (...args: infer Parameters) => infer ReturnType ? (ReturnType extends PromiseLike<infer ReturnType> ? ((...args: RemoteFunctionParameters<Parameters>) => ReturnType | PromiseLike<ReturnType>) | Remote<T> : Remote<T>) : never;
 ...
 * @public
 */
export type LocalConstructor<T extends new (...args: any[]) => any> = T extends new (...args: infer Parameters) => infer ReturnType
 ...
 * @public
 */
export type RemoteReturnType<T> = [T] extends [never] ? Remote<T> : T extends PromiseLike<infer T> ? RemoteReturnType<T> : T extends Primitives ? RemotePrimitiveReadonly<T> : T extends Remote<infer Local> ? PromiseLike<Local> : Remote<T>;
